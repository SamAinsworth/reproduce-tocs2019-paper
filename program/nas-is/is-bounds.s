...
full_verify:                            # @full_verify
	.cfi_startproc
# BB#0:
	movq	key_buff_ptr_global(%rip), %r9
	xorl	%ecx, %ecx
	movl	$33554431, %r8d         # imm = 0x1FFFFFF
	.p2align	4, 0x90
.LBB2_1:                                # =>This Inner Loop Header: Depth=1
	movslq	key_buff2(,%rcx,4), %rsi
	leaq	32(%rcx), %rdi
	cmpq	$33554431, %rdi         # imm = 0x1FFFFFF
	cmovgq	%r8, %rdi
	movslq	key_buff2(,%rdi,4), %rdi
	movslq	(%r9,%rsi,4), %rdx
	leaq	-1(%rdx), %rax
	movl	%eax, (%r9,%rsi,4)
	movl	%esi, key_array-4(,%rdx,4)
	prefetcht0	key_buff2+256(,%rcx,4)
	incq	%rcx
	prefetcht0	(%r9,%rdi,4)
...
.LBB3_1:                                # =>This Inner Loop Header: Depth=1
	movslq	key_buff2(,%rbx,4), %rcx
	leaq	32(%rbx), %rdx
	cmpq	$33554431, %rdx         # imm = 0x1FFFFFF
	cmovgq	%rax, %rdx
	movslq	key_buff2(,%rdx,4), %rdx
	incl	key_buff1(,%rcx,4)
	prefetcht0	key_buff2+256(,%rbx,4)
	incq	%rbx
	prefetcht0	key_buff1(,%rdx,4)
...
.LBB4_1:                                # =>This Inner Loop Header: Depth=1
	movslq	key_buff2(,%rbx,4), %rdx
	leaq	32(%rbx), %rsi
	cmpq	$33554431, %rsi         # imm = 0x1FFFFFF
	cmovgq	%r8, %rsi
	movslq	key_buff2(,%rsi,4), %rsi
