...
if [ "${CK_COMPILE_TYPE}" == "auto" ] ; then
  echo "*** auto ***"
  EXECUTE1="$CK_COMPILER ../cg.c   -fopenmp=libomp -Xclang -load -Xclang ${CK_ENV_PLUGIN_LLVM_SW_PREFETCH_PASS_FILE} -c -S -emit-llvm"
  EXECUTE2="$CK_COMPILER cg.ll -c"
  EXECUTE3="$CK_COMPILER cg.o   -fopenmp=libomp ${CK_NAS_COMMON}/c_print_results.c ${CK_NAS_COMMON}/c_timers.c ${CK_NAS_COMMON}/wtime.c ${CK_NAS_COMMON}/c_randdp.c -lm"

elif [ "${CK_COMPILE_TYPE}" == "auto-nostride" ] ; then
  echo "*** auto-nostride ***"
  EXECUTE1="$CK_COMPILER ../cg.c   -fopenmp=libomp -Xclang -load -Xclang ${CK_ENV_PLUGIN_LLVM_SW_PREFETCH_NO_STRIDES_PASS_FILE} -c -S -emit-llvm"
  EXECUTE2="$CK_COMPILER cg.ll -c"
  EXECUTE3="$CK_COMPILER cg.o   -fopenmp=libomp ${CK_NAS_COMMON}/c_print_results.c ${CK_NAS_COMMON}/c_timers.c ${CK_NAS_COMMON}/wtime.c ${CK_NAS_COMMON}/c_randdp.c -lm"
  ...
  echo "*** no ***"
  EXECUTE1="$CK_COMPILER ../cg.c  -fopenmp=libomp -c"
  EXECUTE2=""
  EXECUTE3="$CK_COMPILER cg.o  -fopenmp=libomp ${CK_NAS_COMMON}/c_print_results.c ${CK_NAS_COMMON}/c_timers.c ${CK_NAS_COMMON}/wtime.c ${CK_NAS_COMMON}/c_randdp.c -lm"
fi
