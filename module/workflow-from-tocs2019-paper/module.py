...
#
# Developer: Sam Ainsworth, sam.ainsworth@cl.cam.ac.uk, http://www.cl.cam.ac.uk/~sa614/
#
    ...
    for x in range(2,11):   
        for y in [0, 1, x-1]: 
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  ...
                  'env':{'CK_COMPILE_TYPE':'no', 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':'0', 'CK_KANGAROO_HASHES':str(y)},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
            ...
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['kangaroo'],
                  'env':{'CK_COMPILE_TYPE':'auto', 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':'0', 'CK_KANGAROO_HASHES':str(y)},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
                  'title':'Reproducing experiments for Figure 13',
...
# Reproducing Figure 14 ###################################################################################
    for x in range(2,11):   
        r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['kangaroo'],
                  'env':{'CK_COMPILE_TYPE':'no', 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':'0', 'CK_KANGAROO_HASHES':'0'},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
        ...
        for y in range(1,x): 
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['kangaroo'],
                  'env':{'CK_COMPILE_TYPE':'man', 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':str(y), 'CK_KANGAROO_HASHES':'0'},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
                  'title':'',
                  'subtitle':'Validating kangaroo manual prefetching: ' + str(x) + "-" + str(y),
                  'key':'figure-14-'   + str(x) + "-" + str(y) + 'man-prefetching', 'results':results})
            if r['return']>0:
                log({'string':''})
                log({'string':'Experiment failed ('+r['error']+')'})
...
# Reproducing Figure 15 ###################################################################################
    for x in range(9,11):   
        r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['kangaroo'],
                  'env':{'CK_COMPILE_TYPE':'no', 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':'0', 'CK_KANGAROO_HASHES':str(x-1)},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
        ...
        for y in range(1,x): 
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['kangaroo'],
                  'env':{'CK_COMPILE_TYPE':'man', 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':str(y), 'CK_KANGAROO_HASHES':str(x-1)},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
                  'title':'',
                  'subtitle':'Validating kangaroo manual prefetching: ' + str(x) + "-" + str(y),
                  'key':'figure-15-'   + str(x) + "-" + str(y) + 'man-prefetching', 'results':results})
            if r['return']>0:
                log({'string':''})
                log({'string':'Experiment failed ('+r['error']+')'})
    ...
    for x in range(2,11):   
        ...
        for y in range(1,x): 
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  ...
                  'title':'',
                  'subtitle':'Validating kangaroo manual prefetching: ' + str(x) + "-" + str(y),
                  'key':'figure-17-'   + str(x) + "-" + str(y) + 'man-prefetching-64', 'results':results})
            if r['return']>0:
                log({'string':''})
                log({'string':'Experiment failed ('+r['error']+')'})                
            ...
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['kangaroo'],
                  'env':{'CK_COMPILE_TYPE':'offset', 'CK_FETCHDIST':str(x), 'CK_KANGAROO_ARRAYS':str(x), 'CK_KANGAROO_NUMPFS':str(y), 'CK_KANGAROO_HASHES':'0'},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
                  'title':'',
                  'subtitle':'Validating kangaroo offset prefetching: ' + str(x) + "-" + str(y),
                  'key':'figure-17-'   + str(x) + "-" + str(y) + 'man-prefetching-16', 'results':results})
            if r['return']>0:
                log({'string':''})
                log({'string':'Experiment failed ('+r['error']+')'})
...
# Reproducing Figure 21 ###################################################################################
        
    for x in range(0,31):   
            r=experiment({'host_os':hos, 'target_os':tos, 'device_id':tdid, 'out':oo,
                  'program_uoa':cfg['programs_uoa']['camel'],
                  'env':{'CK_COMPILE_TYPE':'no', 'CK_CAMEL_HASHES':str(x)},
                  'deps':deps,
                  'quiet':q, 'record':rec, 'record_repo_uoa':rruid, 'record_data_uoa':rduid, 'os_abi':os_abi,
                  'title':'Reproducing experiments for Figure 21',
                  'subtitle':'Validating camel no prefetching: '  + str(x),
                  'key':'figure-21-'   + str(x) + '-no-prefetching', 'results':results})    
            if r['return']>0:
                log({'string':''})
                log({'string':'Experiment failed ('+r['error']+')'})
